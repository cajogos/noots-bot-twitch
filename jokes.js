...
function getKnockKnockJoke()
{
    return jokes.knockknock[Math.floor(Math.random() * jokes.knockknock.length)];
}

function getProgrammingJoke()
{
    return jokes.programming[Math.floor(Math.random() * jokes.programming.length)];
}
